<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="(addr, index) in address" :key="addr.id">
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        consigee: this.userDefaultAddress.consigee,
        consigeeTel: this.userDefaultAddress.phoneNum,
